...
<div class="ui padded grid">
    <div class="eleven wide column">
        ...
        <!--            $("#btn1").click(function () {-->
        <!--                viewer.clear();-->
        <!--                $3Dmol.download('pdb:' + $('#pdbid').val(), viewer, {doAssembly: true, noSecondaryStructure: false});-->
        <!--            });-->
    ...
    <div class="five wide column">
        <div>
            <div class="treemenu boxed">
                <div class="ui styled fluid accordion" id="mainoperation">
                        ...
                        <form>
                            <div class="ui input" id="entry">
                                ...
                                <button class="ui mini icon button" style="background-color: lightskyblue;"
                                        onclick='loadPDB()' type="button"><i class="search icon"></i>Click it to search
                                </button>
                            </div>
                    ...
                    <div class="content" id="corrsitecont">
                    ...
                    <div class="title" id="cyspredtitle">
                        <i class="dropdown icon"></i> <b>CovCys </b>
                    </div>
                    <div class="content" id="cyspredcont">
                        <form>
